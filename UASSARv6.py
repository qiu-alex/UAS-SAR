...
def interp_approach(pulses, range_axis, platform_pos, x_vec, y_vec, height):
    """
...
def parse_args(args):
    ...
    parser.add_argument('y_bounds', nargs=2, type=float, 
                        help=('Minimum and maximum bounds of the Y coordinates'
                              ' of the image (m)'))
    parser.add_argument('zvalue', nargs=1, type=float, 
                        help=('The altitude to'
                              ' measure at (m)'))
   ...
   '''
    ...
    if parsed_args.method == 'shift':
        ...
        complex_image = interp_approach(
                pulses, range_axis, platform_pos, x_vec, y_vec, height)
